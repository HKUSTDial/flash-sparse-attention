...
struct QKVB_params {
    ...
    void *__restrict__ b_ptr;       // Bias tensor [batch_size, num_b_heads, query_len, key_len]
    ...
    index_t b_batch_stride;         // Stride between batches of B
    ...
    index_t b_row_stride;           // Stride between rows of B
    ...
    index_t b_head_stride;          // Stride between heads of B

    // The number of heads.
    int h, h_k, h_b;
    // In the case of multi-query and grouped-query attention, nheads_k could be different from nheads.
    int h_h_k_ratio, h_h_b_ratio;   // precompute h / h_k, h / h_b
};
...
struct Flash_bwd_params : public Flash_fwd_params {
    ...
    index_t db_head_stride;
    index_t db_row_stride;
