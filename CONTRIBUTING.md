...
However you choose to contribute, please be mindful and respect our [code of conduct](https://github.com/HKUSTDial/flash-sparse-attention/blob/main/CODE_OF_CONDUCT.md).
...
If you don't know where to start, there is a special [Good First Issue](https://github.com/HKUSTDial/flash-sparse-attention/contribute) listing. It will give you a list of open issues that are beginner-friendly and help you start contributing to open-source.
...
1. Fork the [repository](https://github.com/HKUSTDial/flash-sparse-attention) by clicking on the **Fork** button.
...
2. Clone your fork to your local disk, and add the base repository as a remote:
   ...
   git remote add upstream https://github.com/HKUSTDial/flash-sparse-attention.git
   ```
...
An extensive test suite is included to test the library behavior and performance. Tests can be found in the [tests](https://github.com/HKUSTDial/flash-sparse-attention/tree/main/tests) folder and benchmarks in the [benchmarks](https://github.com/HKUSTDial/flash-sparse-attention/tree/main/benchmarks) folder.
...
If you have questions about contributing, feel free to ask in the [GitHub Discussions](https://github.com/HKUSTDial/flash-sparse-attention/discussions) or open an issue.
